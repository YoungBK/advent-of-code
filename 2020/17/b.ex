defmodule AdventOfCode202017.B do
  use Bitwise
...
""" |> String.trim()
  ...
  def create_elements(result, [head|rest], row, col) do
    Map.put(result, {row,col,0,0}, head)
  ...
  def neighbors_of(state, {r,c,z,w}) do
    [{r-1, c-1, z-1, w-1}, {r-1, c, z-1, w-1}, {r-1, c+1, z-1, w-1},
     {r, c-1, z-1, w-1},   {r, c, z-1, w-1 },   {r, c+1, z-1, w-1},
     {r+1, c-1, z-1, w-1}, {r+1, c, z-1, w-1}, {r+1, c+1, z-1, w-1},

     {r-1, c-1, z, w-1}, {r-1, c, z, w-1}, {r-1, c+1, z, w-1},
     {r, c-1, z, w-1},   {r, c, z, w-1},   {r, c+1, z, w-1},
     {r+1, c-1, z, w-1}, {r+1, c, z, w-1}, {r+1, c+1, z, w-1},
     ...
     {r-1, c-1, z-1, w}, {r-1, c, z-1, w}, {r-1, c+1, z-1, w},
     {r, c-1, z-1, w},   {r, c, z-1, w },   {r, c+1, z-1, w},
     {r+1, c-1, z-1, w}, {r+1, c, z-1, w}, {r+1, c+1, z-1, w},

     {r-1, c-1, z, w}, {r-1, c, z, w}, {r-1, c+1, z, w},
     {r, c-1, z, w},                   {r, c+1, z, w},
     {r+1, c-1, z, w}, {r+1, c, z, w}, {r+1, c+1, z, w},
